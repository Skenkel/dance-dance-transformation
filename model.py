...
# todo rewrite decoder to a classifier, needs to output a sigmoid 0/1 for is a step or isn't a step. 

    def __init__(self, input_size=274, hidden_size=200,
    ...
    def forward(self, in_frame, vec_h, vec_c): 
        ...
        self.linear(dimensions)
        classification = self.sigmoid
